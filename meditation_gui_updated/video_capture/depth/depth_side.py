...
def analyzeVideo(video_path, reference_angles1, reference_landmarks1,reference_angles2, reference_landmarks2,reference_angles3, reference_landmarks3,reference_angles4, reference_landmarks4,reference_angles5, reference_landmarks5,reference_angles6, reference_landmarks6,reference_angles7, reference_landmarks7,reference_angles8, reference_landmarks8,reference_angles9, reference_landmarks9):
    with mp_pose.Pose(min_detection_confidence=0.35, model_complexity=2) as pose:
        ...
        out = cv2.VideoWriter('output_analyzed.mp4', fourcc, 20.0, (int(cap.get(3)) * 2, int(cap.get(4))))  # Output file setup
        ...
        while cap.isOpened() and cap2.isOpened():
            ...
            cv2.imshow('Original vs Analyzed Video', combined_frame_resized)
...
reference_image_path1 = 'Screenshot 2024-12-12 111026.png'
reference_image_path2 = 'Screenshot 2024-12-12 111149.png'
reference_image_path3 = 'Screenshot 2024-12-12 111319.png'
reference_image_path4 = 'Screenshot 2024-12-12 112640.png'
reference_image_path5 = 'Screenshot 2024-12-12 111506.png'
reference_image_path6 = 'Screenshot 2024-12-12 111707.png'
reference_image_path7 = 'Screenshot 2024-12-12 111747.png'
reference_image_path8 = 'Screenshot 2024-12-12 112447.png'
reference_image_path9 = 'Screenshot 2024-12-12 112553.png'

video_path = 'BK_1_FIVE_MINS.mp4'
