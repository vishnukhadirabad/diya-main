...
from paths import FRONT_CAM_INDEX, project_path, upright, upright_size
...
def processImage(image_path):
    with nullcontext(_reference_pose()) as pose:
...
def analyzeVideo(reference_angles1, reference_landmarks1,reference_angles2, reference_landmarks2,reference_angles3, reference_landmarks3,reference_angles4, reference_landmarks4,reference_angles5, reference_landmarks5,reference_angles6, reference_landmarks6,reference_angles7, reference_landmarks7,reference_angles8, reference_landmarks8,reference_angles9, reference_landmarks9):
    with mp_pose.Pose(min_detection_confidence=0.35, model_complexity=2) as pose:
        cap = cv2.VideoCapture(FRONT_CAM_INDEX)
        #cap2 = cv2.VideoCapture(video_path)

        # Define the codec and create VideoWriter object
        fourcc = cv2.VideoWriter_fourcc(*'XVID')  # Codec
        output_path = project_path('visual1_video.avi')
        # Size must follow the rotation applied by upright(), or VideoWriter drops
        # every frame and the posture video comes out empty.
        out = cv2.VideoWriter(str(output_path), fourcc, 30.0, upright_size(640, 480))
...
reference_image_path1 = project_path('Screenshot from 2024-10-30 11-45-14.png')
reference_image_path2 = project_path('Screenshot 2024-11-08 122356.png')
reference_image_path3 = project_path('Screenshot 2024-11-08 122257.png')
reference_image_path4 = project_path('Screenshot 2024-11-08 122008.png')
reference_image_path5 = project_path('Screenshot 2024-11-08 121728.png')
reference_image_path6 = project_path('Screenshot 2024-11-08 121652.png')
reference_image_path7 = project_path('Screenshot 2024-11-08 121631.png')
reference_image_path8 = project_path('Screenshot 2024-11-08 121523.png')
reference_image_path9 = project_path('Screenshot 2024-11-08 121407.png')
